...
public class AttributeConstraintsCodeGenerationTest {
	...
	public void testGenerateCode() throws InvocationTargetException {
		...
		final URI uri1 = URI.createPlatformResourceURI(
				...
				true);
		final Resource r = rs.getResource(uri1, true);
		final AttributeConstraintLibrary lib = (AttributeConstraintLibrary) r.getContents().get(0);
		@SuppressWarnings("unused")
		final OperationSpecificationGroup group = lib.getOperationSpecifications().get(0);
	}
