...
public class OperationSpecificationGroupImpl extends EObjectImpl implements OperationSpecificationGroup
{
                  ...
                  && newAttributeConstraintLibrary != null))
      {
         ...
         if (newAttributeConstraintLibrary != null)
            msgs = ((InternalEObject) newAttributeConstraintLibrary).eInverseAdd(this,
                  OperationspecificationPackage.ATTRIBUTE_CONSTRAINT_LIBRARY__OPERATION_SPECIFICATIONS, AttributeConstraintLibrary.class, msgs);
         msgs = basicSetAttributeConstraintLibrary(newAttributeConstraintLibrary, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__ATTRIBUTE_CONSTRAINT_LIBRARY,
   ...
   public EList<ConstraintSpecification> getConstraintSpecifications()
   {
      ...
      {
         constraintSpecifications = new EObjectWithInverseResolvingEList<ConstraintSpecification>(ConstraintSpecification.class, this,
   ...
   public EList<OperationSpecification> getOperationSpecifications()
   {
      ...
      {
         operationSpecifications = new EObjectContainmentEList<OperationSpecification>(OperationSpecification.class, this,
   ...
   public void setOperationIdentifier(String newOperationIdentifier)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__OPERATION_IDENTIFIER,
   ...
   public void setTemplateGroupGenerated(boolean newTemplateGroupGenerated)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__TEMPLATE_GROUP_GENERATED,
   ...
   public void setTemplateGroupString(String newTemplateGroupString)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__TEMPLATE_GROUP_STRING,
   ...
   public ErrorMessage gernerateTemplate()
   {
      ...
      for (OperationSpecification opSpec : this.getOperationSpecifications())
      {
         ...
         for (int i = 0; i < parameterIdlist.size(); i++)
         {
            ...
            userOpTemplateString = userOpTemplateString.replace(identifier,
                  OUTER_ST_DELIMITER + "p" + i + "()" + OUTER_ST_DELIMITER + OUTER_ST_DELIMITER + "Param()" + OUTER_ST_DELIMITER);
            if (opSpec.getAdornmentString().charAt(i) == 'F')
            {
               declarationTemplateString = declarationTemplateString + OUTER_ST_DELIMITER + "p" + i + "()" + OUTER_ST_DELIMITER + OUTER_ST_DELIMITER + "Decl()"
                     + OUTER_ST_DELIMITER + ";\n";
            }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      ...
      case OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__CONSTRAINT_SPECIFICATIONS:
         return ((InternalEList<InternalEObject>) (InternalEList<?>) getConstraintSpecifications()).basicAdd(otherEnd, msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
      case OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__ATTRIBUTE_CONSTRAINT_LIBRARY:
         return eInternalContainer().eInverseRemove(this, OperationspecificationPackage.ATTRIBUTE_CONSTRAINT_LIBRARY__OPERATION_SPECIFICATIONS,
   ...
   public boolean eIsSet(int featureID)
   {
      ...
      case OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__TEMPLATE_GROUP_STRING:
         return TEMPLATE_GROUP_STRING_EDEFAULT == null ? templateGroupString != null : !TEMPLATE_GROUP_STRING_EDEFAULT.equals(templateGroupString);
      }
