...
public class AttributeConstraintLibraryImpl extends EObjectImpl implements AttributeConstraintLibrary
{
   ...
   public EList<OperationSpecificationGroup> getOperationSpecifications()
   {
      ...
      {
         operationSpecifications = new EObjectContainmentWithInverseEList<OperationSpecificationGroup>(OperationSpecificationGroup.class, this,
   ...
   public EList<ConstraintSpecification> getConstraintSpecifications()
   {
      ...
      {
         constraintSpecifications = new EObjectContainmentWithInverseEList<ConstraintSpecification>(ConstraintSpecification.class, this,
   ...
   public void setPrefix(String newPrefix)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.ATTRIBUTE_CONSTRAINT_LIBRARY__PREFIX, oldPrefix, prefix));
   }
         ...
         if (constSpec.getSymbol().equals(constraint.getPredicateSymbol()))
         {
            if (constraint.getParameters().size() == constSpec.getParameterTypes().size())
            {
               ...
               for (int i = 0; i < constraint.getParameters().size(); i++)
               {
                  ...
                  {
                     throw new RuntimeException("AttributeConstraintLibrary: unknown variable type: " + cVariable.getClass().getName());
                  }
               }
               if (successful)
               {
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
   {
      ...
      case OperationspecificationPackage.ATTRIBUTE_CONSTRAINT_LIBRARY__OPERATION_SPECIFICATIONS:
         return ((InternalEList<InternalEObject>) (InternalEList<?>) getOperationSpecifications()).basicAdd(otherEnd, msgs);
