...
public class OperationspecificationPackageImpl extends EPackageImpl implements OperationspecificationPackage
{
   ...
   {
      if (isInited)
         return (OperationspecificationPackage) EPackage.Registry.INSTANCE.getEPackage(OperationspecificationPackage.eNS_URI);
      ...
      OperationspecificationPackageImpl theOperationspecificationPackage = (OperationspecificationPackageImpl) (EPackage.Registry.INSTANCE
            .get(eNS_URI) instanceof OperationspecificationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OperationspecificationPackageImpl());
   ...
   public void createPackageContents()
   {
      ...
      createEOperation(attributeConstraintLibraryEClass, ATTRIBUTE_CONSTRAINT_LIBRARY___LOOKUP_CONSTRAINT_TYPE__ATTRIBUTEVARIABLECONSTRAINT);

      operationSpecificationGroupEClass = createEClass(OPERATION_SPECIFICATION_GROUP);
      createEReference(operationSpecificationGroupEClass, OPERATION_SPECIFICATION_GROUP__ATTRIBUTE_CONSTRAINT_LIBRARY);
   ...
   public void initializePackageContents()
   {
      ...
      initEClass(operationSpecificationEClass, OperationSpecification.class, "OperationSpecification", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getOperationSpecification_Specification(), ecorePackage.getEString(), "specification", null, 1, 1, OperationSpecification.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEAttribute(getOperationSpecification_AdornmentString(), ecorePackage.getEString(), "adornmentString", null, 1, 1, OperationSpecification.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEAttribute(getOperationSpecification_AlwaysSuccessful(), ecorePackage.getEBoolean(), "alwaysSuccessful", "true", 1, 1, OperationSpecification.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(constraintTypeEClass, ConstraintType.class, "ConstraintType", IS_ABSTRACT, IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);

      initEClass(attributeConstraintLibraryEClass, AttributeConstraintLibrary.class, "AttributeConstraintLibrary", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);
      initEReference(getAttributeConstraintLibrary_OperationSpecifications(), this.getOperationSpecificationGroup(),
            this.getOperationSpecificationGroup_AttributeConstraintLibrary(), "operationSpecifications", null, 0, -1, AttributeConstraintLibrary.class,
      ...
      initEReference(getAttributeConstraintLibrary_ConstraintSpecifications(), this.getConstraintSpecification(),
            this.getConstraintSpecification_AttributeConstraintLibrary(), "constraintSpecifications", null, 0, -1, AttributeConstraintLibrary.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getAttributeConstraintLibrary_Prefix(), ecorePackage.getEString(), "prefix", null, 1, 1, AttributeConstraintLibrary.class, !IS_TRANSIENT,
            !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      EOperation op = initEOperation(getAttributeConstraintLibrary__LookupConstraintType__AttributeVariableConstraint(), this.getConstraintSpecification(),
            "lookupConstraintType", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theDemoclesPackage.getAttributeVariableConstraint(), "constraint", 0, 1, IS_UNIQUE, IS_ORDERED);

      initEClass(operationSpecificationGroupEClass, OperationSpecificationGroup.class, "OperationSpecificationGroup", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);
      initEReference(getOperationSpecificationGroup_AttributeConstraintLibrary(), this.getAttributeConstraintLibrary(),
            this.getAttributeConstraintLibrary_OperationSpecifications(), "attributeConstraintLibrary", null, 1, 1, OperationSpecificationGroup.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getOperationSpecificationGroup_ConstraintSpecifications(), this.getConstraintSpecification(),
            this.getConstraintSpecification_OperationSpecificationGroup(), "constraintSpecifications", null, 0, -1, OperationSpecificationGroup.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getOperationSpecificationGroup_OperationSpecifications(), this.getOperationSpecification(), null, "operationSpecifications", null, 0, -1,
            OperationSpecificationGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
            !IS_DERIVED, IS_ORDERED);
      initEReference(getOperationSpecificationGroup_ParameterIDs(), this.getParamIdentifier(), this.getParamIdentifier_OperationSpecificationGroup(),
            "parameterIDs", null, 0, -1, OperationSpecificationGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
            !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getOperationSpecificationGroup_OperationIdentifier(), ecorePackage.getEString(), "operationIdentifier", null, 1, 1,
            OperationSpecificationGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEAttribute(getOperationSpecificationGroup_TemplateGroupGenerated(), ecorePackage.getEBoolean(), "templateGroupGenerated", null, 1, 1,
            OperationSpecificationGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEAttribute(getOperationSpecificationGroup_TemplateGroupString(), ecorePackage.getEString(), "templateGroupString", null, 1, 1,
            OperationSpecificationGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEOperation(getOperationSpecificationGroup__GernerateTemplate(), theResultPackage.getErrorMessage(), "gernerateTemplate", 0, 1, IS_UNIQUE, IS_ORDERED);

      initEClass(paramIdentifierEClass, ParamIdentifier.class, "ParamIdentifier", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getParamIdentifier_OperationSpecificationGroup(), this.getOperationSpecificationGroup(),
            this.getOperationSpecificationGroup_ParameterIDs(), "operationSpecificationGroup", null, 1, 1, ParamIdentifier.class, !IS_TRANSIENT, !IS_VOLATILE,
            IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getParamIdentifier_Identifier(), ecorePackage.getEString(), "identifier", null, 1, 1, ParamIdentifier.class, !IS_TRANSIENT, !IS_VOLATILE,
            IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(constraintSpecificationEClass, ConstraintSpecification.class, "ConstraintSpecification", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);
      initEReference(getConstraintSpecification_AttributeConstraintLibrary(), this.getAttributeConstraintLibrary(),
            this.getAttributeConstraintLibrary_ConstraintSpecifications(), "attributeConstraintLibrary", null, 1, 1, ConstraintSpecification.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getConstraintSpecification_ParameterTypes(), this.getParameterType(), null, "parameterTypes", null, 0, -1, ConstraintSpecification.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getConstraintSpecification_OperationSpecificationGroup(), this.getOperationSpecificationGroup(),
            this.getOperationSpecificationGroup_ConstraintSpecifications(), "operationSpecificationGroup", null, 1, 1, ConstraintSpecification.class,
            !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEAttribute(getConstraintSpecification_Symbol(), ecorePackage.getEString(), "symbol", null, 1, 1, ConstraintSpecification.class, !IS_TRANSIENT,
            !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(parameterTypeEClass, ParameterType.class, "ParameterType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getParameterType_Type(), ecorePackage.getEClassifier(), null, "type", null, 0, 1, ParameterType.class, !IS_TRANSIENT, !IS_VOLATILE,
            IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
