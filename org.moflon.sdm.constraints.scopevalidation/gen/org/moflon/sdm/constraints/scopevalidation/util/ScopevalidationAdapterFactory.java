...
public class ScopevalidationAdapterFactory extends AdapterFactoryImpl
{
   ...
   protected ScopevalidationSwitch<Adapter> modelSwitch = new ScopevalidationSwitch<Adapter>() {
      @Override
      public Adapter caseAttributeConstraintBlackPatternInvocationBuilder(AttributeConstraintBlackPatternInvocationBuilder object)
      {
         return createAttributeConstraintBlackPatternInvocationBuilderAdapter();
      }

      @Override
      public Adapter caseAttributeConstraintGreenPatternInvocationBuilder(AttributeConstraintGreenPatternInvocationBuilder object)
      {
