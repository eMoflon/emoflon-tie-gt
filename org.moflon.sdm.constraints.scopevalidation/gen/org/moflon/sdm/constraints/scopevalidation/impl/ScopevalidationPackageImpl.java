...
public class ScopevalidationPackageImpl extends EPackageImpl implements ScopevalidationPackage
{
   ...
   public static ScopevalidationPackage init()
   {
      ...
      ScopevalidationPackageImpl theScopevalidationPackage = (ScopevalidationPackageImpl) (EPackage.Registry.INSTANCE
            .get(eNS_URI) instanceof ScopevalidationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ScopevalidationPackageImpl());
   ...
   public void createPackageContents()
   {
      ...
      attributeConstraintBlackPatternInvocationBuilderEClass = createEClass(ATTRIBUTE_CONSTRAINT_BLACK_PATTERN_INVOCATION_BUILDER);
      ...
      createEOperation(attributeConstraintBlackPatternInvocationBuilderEClass, ATTRIBUTE_CONSTRAINT_BLACK_PATTERN_INVOCATION_BUILDER___CONCAT__STRING_INT);
      createEOperation(attributeConstraintBlackPatternInvocationBuilderEClass,
      ...
      attributeConstraintGreenPatternInvocationBuilderEClass = createEClass(ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_INVOCATION_BUILDER);
   ...
   public void initializePackageContents()
   {
      ...
      attributeConstraintBlackPatternInvocationBuilderEClass.getESuperTypes().add(theScopePackage.getBlackPatternBuilder());
      attributeConstraintGreenPatternInvocationBuilderEClass.getESuperTypes().add(this.getAttributeConstraintBlackPatternInvocationBuilder());

      // Initialize classes, features, and operations; add parameters
      initEClass(attributeConstraintBlackPatternInvocationBuilderEClass, AttributeConstraintBlackPatternInvocationBuilder.class,
            "AttributeConstraintBlackPatternInvocationBuilder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

      EOperation op = initEOperation(getAttributeConstraintBlackPatternInvocationBuilder__AnalyzeDependencies__PatternInvocationBuilder_StoryPattern_Pattern(),
            null, "analyzeDependencies", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theScopePackage.getPatternInvocationBuilder(), "patternInvocationBuilder", 0, 1, IS_UNIQUE, IS_ORDERED);
      ...
      op = initEOperation(getAttributeConstraintBlackPatternInvocationBuilder__CallSuperAnalyzeDependencies__PatternInvocationBuilder_StoryPattern_Pattern(),
            null, "callSuperAnalyzeDependencies", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theScopePackage.getPatternInvocationBuilder(), "patternInvocationBuilder", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, thePatternsPackage.getStoryPattern(), "storyPattern", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackPatternInvocationBuilder__Concat__String_int(), ecorePackage.getEString(), "concat", 0, 1, IS_UNIQUE,
            IS_ORDERED);
      ...
      op = initEOperation(getAttributeConstraintBlackPatternInvocationBuilder__CalcLocalVariableName__Variable(), ecorePackage.getEString(),
            "calcLocalVariableName", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getVariable(), "variable", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackPatternInvocationBuilder__HandleAttrVariableReference__Variable_EClassifier(),
            theDemoclesPackage.getVariableReference(), "handleAttrVariableReference", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getVariable(), "variable", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, ecorePackage.getEClassifier(), "variableType", 0, 1, IS_UNIQUE, IS_ORDERED);

      initEClass(attributeConstraintGreenPatternInvocationBuilderEClass, AttributeConstraintGreenPatternInvocationBuilder.class,
            "AttributeConstraintGreenPatternInvocationBuilder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

      op = initEOperation(getAttributeConstraintGreenPatternInvocationBuilder__ValidateVariable__Action_CFVariable_ObjectVariable(), null, "validateVariable",
