 ...
 * <ul>
 * <li>{@link org.moflon.sdm.compiler.democles.validation.result.ValidationReport#getErrorMessages
 * <em>Error Messages</em>}</li>
 * <li>{@link org.moflon.sdm.compiler.democles.validation.result.ValidationReport#getResult
 * <em>Result</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ValidationReport extends EObject {
	/**
	 * Returns the value of the '<em><b>Error Messages</b></em>' containment
	 * reference list. The list contents are of type
	 * {@link org.moflon.sdm.compiler.democles.validation.result.ErrorMessage}. It
	 * is bidirectional and its opposite is
	 * '{@link org.moflon.sdm.compiler.democles.validation.result.ErrorMessage#getValidationReport
	 * <em>Validation Report</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Error Messages</em>' containment reference list
	 * isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 * @return the value of the '<em>Error Messages</em>' containment reference
	 *         list.
	 ...
	 * '{@link org.moflon.sdm.compiler.democles.validation.result.ValidationReport#getResult
