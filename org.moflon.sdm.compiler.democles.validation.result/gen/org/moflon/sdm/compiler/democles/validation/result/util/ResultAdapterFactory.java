/**
 */
package org.moflon.sdm.compiler.democles.validation.result.util;
...
public class ResultAdapterFactory extends AdapterFactoryImpl
{
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.moflon.sdm.compiler.democles.validation.result.ErrorMessage <em>Error Message</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.moflon.sdm.compiler.democles.validation.result.ValidationReport <em>Validation Report</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
