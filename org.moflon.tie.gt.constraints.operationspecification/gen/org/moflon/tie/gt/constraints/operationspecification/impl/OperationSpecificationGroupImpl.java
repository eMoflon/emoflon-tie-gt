...
import static org.moflon.tie.gt.constraints.operationspecification.AttributeConstraintsOperationActivator.INNER_ST_DELIMITER;
import static org.moflon.tie.gt.constraints.operationspecification.AttributeConstraintsOperationActivator.OUTER_ST_DELIMITER;
 ...
 * <ul>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#getAttributeConstraintLibrary
 * <em>Attribute Constraint Library</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#getConstraintSpecifications
 * <em>Constraint Specifications</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#getOperationSpecifications
 * <em>Operation Specifications</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#getParameterIDs
 * <em>Parameter IDs</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#getOperationIdentifier
 * <em>Operation Identifier</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#isTemplateGroupGenerated
 * <em>Template Group Generated</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationGroupImpl#getTemplateGroupString
...
public class OperationSpecificationGroupImpl extends EObjectImpl implements OperationSpecificationGroup {
	/**
	 * The cached value of the '{@link #getConstraintSpecifications() <em>Constraint
	 * Specifications</em>}' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getOperationSpecifications() <em>Operation
	 * Specifications</em>}' containment reference list. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getParameterIDs() <em>Parameter IDs</em>}'
	...
	/**
	 * The default value of the '{@link #getOperationIdentifier() <em>Operation
	...
	/**
	 * The cached value of the '{@link #getOperationIdentifier() <em>Operation
	 * Identifier</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOperationIdentifier()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isTemplateGroupGenerated() <em>Template
	 * Group Generated</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isTemplateGroupGenerated() <em>Template
	 * Group Generated</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see #isTemplateGroupGenerated()
	...
	/**
	 * The default value of the '{@link #getTemplateGroupString() <em>Template Group
	...
	/**
	 * The cached value of the '{@link #getTemplateGroupString() <em>Template Group
	 * String</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getTemplateGroupString()
	 * @generated
	...
	public NotificationChain basicSetAttributeConstraintLibrary(
			final AttributeConstraintLibrary newAttributeConstraintLibrary, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setAttributeConstraintLibrary(final AttributeConstraintLibrary newAttributeConstraintLibrary) {
	 ...
	 * @generated
	 */
	public void setOperationIdentifier(final String newOperationIdentifier) {
		final String oldOperationIdentifier = operationIdentifier;
	 ...
	 * @generated
	 */
	public void setTemplateGroupGenerated(final boolean newTemplateGroupGenerated) {
		final boolean oldTemplateGroupGenerated = templateGroupGenerated;
	 ...
	 * @generated
	 */
	public void setTemplateGroupString(final String newTemplateGroupString) {
		final String oldTemplateGroupString = templateGroupString;
	 ...
	 * @generated
	 */
	public void gernerateTemplate() {
		// [user code injected with eMoflon]

		String finalGroupString = "group BuildInConstraints;";
		final List<ParamIdentifier> parameterIdlist = this.getParameterIDs();
		for (final OperationSpecification opSpec : this.getOperationSpecifications()) {
			String userOpTemplateString = opSpec.getSpecification();
			String declarationTemplateString = "";

			for (int i = 0; i < parameterIdlist.size(); i++) {
				final String identifier = INNER_ST_DELIMITER + parameterIdlist.get(i).getIdentifier()
						+ INNER_ST_DELIMITER;
				userOpTemplateString = userOpTemplateString.replace(identifier, OUTER_ST_DELIMITER + "p" + i + "()"
						+ OUTER_ST_DELIMITER + OUTER_ST_DELIMITER + "Param()" + OUTER_ST_DELIMITER);
				if (opSpec.getAdornmentString().charAt(i) == 'F') {
					declarationTemplateString = declarationTemplateString + OUTER_ST_DELIMITER + "p" + i + "()"
							+ OUTER_ST_DELIMITER + OUTER_ST_DELIMITER + "Decl()" + OUTER_ST_DELIMITER + ";\n";
				}

			}

			final STGroup stg = new STGroup(INNER_ST_DELIMITER, INNER_ST_DELIMITER);
			...
			final ST declST = new ST(declarationTemplateString, OUTER_ST_DELIMITER, OUTER_ST_DELIMITER);
			stg.rawDefineTemplate("/userDeclaration", declST.impl, null);

			final ST operationST = new ST(userOpTemplateString, OUTER_ST_DELIMITER, OUTER_ST_DELIMITER);
	...
	private final static String TEMPLATE_LOC = "platform:/plugin/org.moflon.tie.gt.constraints.operationspecification/lib/stringtemplates/basicStringtemplateDef.stg";
