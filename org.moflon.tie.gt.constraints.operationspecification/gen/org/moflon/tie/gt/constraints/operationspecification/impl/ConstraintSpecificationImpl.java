 ...
 * <ul>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getAttributeConstraintLibrary <em>Attribute Constraint Library</em>}</li>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getParameterTypes <em>Parameter Types</em>}</li>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getOperationSpecificationGroup <em>Operation Specification Group</em>}</li>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintSpecificationImpl extends EObjectImpl implements ConstraintSpecification
{
    ...
    * @generated
    */
   public NotificationChain basicSetAttributeConstraintLibrary(AttributeConstraintLibrary newAttributeConstraintLibrary, NotificationChain msgs)
   {
                  ...
                  && newAttributeConstraintLibrary != null))
      {
         ...
         if (newAttributeConstraintLibrary != null)
            msgs = ((InternalEObject) newAttributeConstraintLibrary).eInverseAdd(this,
                  OperationspecificationPackage.ATTRIBUTE_CONSTRAINT_LIBRARY__CONSTRAINT_SPECIFICATIONS, AttributeConstraintLibrary.class, msgs);
         msgs = basicSetAttributeConstraintLibrary(newAttributeConstraintLibrary, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.CONSTRAINT_SPECIFICATION__ATTRIBUTE_CONSTRAINT_LIBRARY,
      ...
      if (operationSpecificationGroup != null && operationSpecificationGroup.eIsProxy())
      {
         ...
         if (operationSpecificationGroup != oldOperationSpecificationGroup)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, OperationspecificationPackage.CONSTRAINT_SPECIFICATION__OPERATION_SPECIFICATION_GROUP,
    ...
    * @generated
    */
   public NotificationChain basicSetOperationSpecificationGroup(OperationSpecificationGroup newOperationSpecificationGroup, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
               OperationspecificationPackage.CONSTRAINT_SPECIFICATION__OPERATION_SPECIFICATION_GROUP, oldOperationSpecificationGroup,
               newOperationSpecificationGroup);
         if (msgs == null)
            msgs = notification;
         else
      ...
      if (newOperationSpecificationGroup != operationSpecificationGroup)
      {
         ...
         if (operationSpecificationGroup != null)
            msgs = ((InternalEObject) operationSpecificationGroup).eInverseRemove(this,
                  OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__CONSTRAINT_SPECIFICATIONS, OperationSpecificationGroup.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.CONSTRAINT_SPECIFICATION__OPERATION_SPECIFICATION_GROUP,
   ...
   public void setSymbol(String newSymbol)
   {
      ...
      symbol = newSymbol;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.CONSTRAINT_SPECIFICATION__SYMBOL, oldSymbol, symbol));
   }
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
      case OperationspecificationPackage.CONSTRAINT_SPECIFICATION__ATTRIBUTE_CONSTRAINT_LIBRARY:
         return eInternalContainer().eInverseRemove(this, OperationspecificationPackage.ATTRIBUTE_CONSTRAINT_LIBRARY__CONSTRAINT_SPECIFICATIONS,
