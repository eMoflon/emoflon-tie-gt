 ...
 * '<em><b>Constraint Specification</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getAttributeConstraintLibrary
 * <em>Attribute Constraint Library</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getParameterTypes
 * <em>Parameter Types</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getOperationSpecificationGroup
 * <em>Operation Specification Group</em>}</li>
 * <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ConstraintSpecificationImpl#getSymbol
 * <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
...
public class ConstraintSpecificationImpl extends EObjectImpl implements ConstraintSpecification {
	/**
	 * The cached value of the '{@link #getParameterTypes() <em>Parameter
	...
	/**
	 * The cached value of the '{@link #getOperationSpecificationGroup()
	 * <em>Operation Specification Group</em>}' reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	public EList<ParameterType> getParameterTypes() {
		if (parameterTypes == null) {
			parameterTypes = new EObjectContainmentEList<>(ParameterType.class, this,
	...
	public OperationSpecificationGroup getOperationSpecificationGroup() {
		if (operationSpecificationGroup != null && operationSpecificationGroup.eIsProxy()) {
			final InternalEObject oldOperationSpecificationGroup = (InternalEObject) operationSpecificationGroup;
	...
	public NotificationChain basicSetOperationSpecificationGroup(
			final OperationSpecificationGroup newOperationSpecificationGroup, NotificationChain msgs) {
		final OperationSpecificationGroup oldOperationSpecificationGroup = operationSpecificationGroup;
	 ...
	 * @generated
	 */
	public void setOperationSpecificationGroup(final OperationSpecificationGroup newOperationSpecificationGroup) {
