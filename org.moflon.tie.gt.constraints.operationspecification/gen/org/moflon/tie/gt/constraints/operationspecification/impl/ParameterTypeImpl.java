 ...
 * <ul>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ParameterTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterTypeImpl extends EObjectImpl implements ParameterType
{
      ...
      if (type != null && type.eIsProxy())
      {
         ...
         if (type != oldType)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, OperationspecificationPackage.PARAMETER_TYPE__TYPE, oldType, type));
         }
      }
      return type;
   }
   ...
   public void setType(EClassifier newType)
   {
      ...
      type = newType;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.PARAMETER_TYPE__TYPE, oldType, type));
   }
