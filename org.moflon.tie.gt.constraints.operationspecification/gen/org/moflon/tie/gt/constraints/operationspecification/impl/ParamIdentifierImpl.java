 ...
 * <ul>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ParamIdentifierImpl#getOperationSpecificationGroup <em>Operation Specification Group</em>}</li>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.ParamIdentifierImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParamIdentifierImpl extends EObjectImpl implements ParamIdentifier
{
   ...
   {
      msgs = eBasicSetContainer((InternalEObject) newOperationSpecificationGroup, OperationspecificationPackage.PARAM_IDENTIFIER__OPERATION_SPECIFICATION_GROUP,
            msgs);
      return msgs;
   }
                  ...
                  && newOperationSpecificationGroup != null))
      {
         ...
         if (newOperationSpecificationGroup != null)
            msgs = ((InternalEObject) newOperationSpecificationGroup).eInverseAdd(this,
                  OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__PARAMETER_IDS, OperationSpecificationGroup.class, msgs);
         msgs = basicSetOperationSpecificationGroup(newOperationSpecificationGroup, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.PARAM_IDENTIFIER__OPERATION_SPECIFICATION_GROUP,
   ...
   public void setIdentifier(String newIdentifier)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.PARAM_IDENTIFIER__IDENTIFIER, oldIdentifier, identifier));
   }
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
      case OperationspecificationPackage.PARAM_IDENTIFIER__OPERATION_SPECIFICATION_GROUP:
         return eInternalContainer().eInverseRemove(this, OperationspecificationPackage.OPERATION_SPECIFICATION_GROUP__PARAMETER_IDS,
