 ...
 * <ul>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationImpl#getAdornmentString <em>Adornment String</em>}</li>
 *   <li>{@link org.moflon.tie.gt.constraints.operationspecification.impl.OperationSpecificationImpl#isAlwaysSuccessful <em>Always Successful</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationSpecificationImpl extends EObjectImpl implements OperationSpecification
{
   ...
   public void setSpecification(String newSpecification)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION__SPECIFICATION, oldSpecification,
               specification));
   }
   ...
   public void setAdornmentString(String newAdornmentString)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION__ADORNMENT_STRING, oldAdornmentString,
               adornmentString));
   }
   ...
   public void setAlwaysSuccessful(boolean newAlwaysSuccessful)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, OperationspecificationPackage.OPERATION_SPECIFICATION__ALWAYS_SUCCESSFUL, oldAlwaysSuccessful,
               alwaysSuccessful));
   }
   ...
   public boolean eIsSet(int featureID)
   {
      ...
      case OperationspecificationPackage.OPERATION_SPECIFICATION__ADORNMENT_STRING:
         return ADORNMENT_STRING_EDEFAULT == null ? adornmentString != null : !ADORNMENT_STRING_EDEFAULT.equals(adornmentString);
      case OperationspecificationPackage.OPERATION_SPECIFICATION__ALWAYS_SUCCESSFUL:
