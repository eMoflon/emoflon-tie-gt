...
import org.moflon.tie.gt.controlflow.democles.BindingPatternInvocation;
...
import org.moflon.tie.gt.controlflow.democles.ReturnStatement;
...
public class DemoclesPackageImpl extends EPackageImpl implements DemoclesPackage {
	 ...
	 * @see org.moflon.tie.gt.controlflow.democles.DemoclesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link DemoclesPackage#eINSTANCE} when that
	...
	public static DemoclesPackage init() {
		...
		final DemoclesPackageImpl theDemoclesPackage = (DemoclesPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof DemoclesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public EAttribute getCFNode_Id() {
		return (EAttribute) cfNodeEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(uniformNoOperationVisitorEClass,
				UNIFORM_NO_OPERATION_VISITOR___VISIT_HEAD_CONTROLLED_LOOP__HEADCONTROLLEDLOOP);
		createEOperation(uniformNoOperationVisitorEClass,
				UNIFORM_NO_OPERATION_VISITOR___VISIT_IF_STATEMENT__IFSTATEMENT);
		createEOperation(uniformNoOperationVisitorEClass,
				UNIFORM_NO_OPERATION_VISITOR___VISIT_TAIL_CONTROLLED_LOOP__TAILCONTROLLEDLOOP);
	...
	public void initializePackageContents() {
		...
		initEClass(repetitionNodeEClass, RepetitionNode.class, "RepetitionNode", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRepetitionNode_LastNodes(), this.getCFNode(), this.getCFNode_Header(), "lastNodes", null, 0,
				-1, RepetitionNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getRepetitionNode__HasShortcuts(), ecorePackage.getEBoolean(), "hasShortcuts", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(loopEClass, Loop.class, "Loop", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLoop_LoopAlongTrue(), ecorePackage.getEBoolean(), "loopAlongTrue", null, 1, 1, Loop.class,
		...
		initEClass(headControlledLoopEClass, HeadControlledLoop.class, "HeadControlledLoop", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		EOperation op = initEOperation(getHeadControlledLoop__Accept__Visitor(), null, "accept", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getVisitor(), "visitor", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(tailControlledLoopEClass, TailControlledLoop.class, "TailControlledLoop", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(compoundNodeEClass, CompoundNode.class, "CompoundNode", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCompoundNode_Scopes(), this.getScope(), this.getScope_Parent(), "scopes", null, 1, -1,
				CompoundNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getCompoundNode__GetRelevantScope(), this.getScope(), "getRelevantScope", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(regularPatternInvocationEClass, RegularPatternInvocation.class, "RegularPatternInvocation",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEOperation(getRegularPatternInvocation__IsMultipleMatch(), ecorePackage.getEBoolean(), "isMultipleMatch", 0,
				1, IS_UNIQUE, IS_ORDERED);

		initEClass(cfVariableEClass, CFVariable.class, "CFVariable", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCFVariable_References(), this.getVariableReference(), this.getVariableReference_From(),
				"references", null, 0, -1, CFVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFVariable_Scope(), this.getScope(), this.getScope_Variables(), "scope", null, 1, 1,
				CFVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFVariable_Reassignments(), this.getAction(), this.getAction_ReassignedVariables(),
				"reassignments", null, 0, -1, CFVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFVariable_Constructor(), this.getAction(), this.getAction_ConstructedVariables(),
				"constructor", null, 0, 1, CFVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFVariable_Type(), ecorePackage.getEClassifier(), null, "type", null, 1, 1, CFVariable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFVariable_Destructors(), this.getNodeDeletion(), this.getNodeDeletion_DestructedVariables(),
				"destructors", null, 0, -1, CFVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCFVariable_Local(), ecorePackage.getEBoolean(), "local", null, 1, 1, CFVariable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getCFVariable_Name(), ecorePackage.getEString(), "name", null, 1, 1, CFVariable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEOperation(getCFVariable__IsOnlyDefined(), ecorePackage.getEBoolean(), "isOnlyDefined", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(cfNodeEClass, CFNode.class, "CFNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCFNode_Scope(), this.getScope(), this.getScope_Contents(), "scope", null, 1, 1, CFNode.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFNode_MainAction(), this.getAction(), null, "mainAction", null, 0, 1, CFNode.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFNode_Actions(), this.getAction(), this.getAction_CfNode(), "actions", null, 0, -1,
				CFNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFNode_Next(), this.getCFNode(), this.getCFNode_Prev(), "next", null, 0, 1, CFNode.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFNode_Prev(), this.getCFNode(), this.getCFNode_Next(), "prev", null, 0, 1, CFNode.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCFNode_Header(), this.getRepetitionNode(), this.getRepetitionNode_LastNodes(), "header", null,
				0, 1, CFNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCFNode_Id(), ecorePackage.getEInt(), "id", null, 1, 1, CFNode.class, !IS_TRANSIENT,
		...
		initEClass(bindingPatternInvocationEClass, BindingPatternInvocation.class, "BindingPatternInvocation",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(singleResultPatternInvocationEClass, SingleResultPatternInvocation.class,
				"SingleResultPatternInvocation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSingleResultPatternInvocation_ReturnType(), ecorePackage.getEClassifier(), null, "returnType",
				null, 0, 1, SingleResultPatternInvocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(scopeEClass, Scope.class, "Scope", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getScope_Parent(), this.getCompoundNode(), this.getCompoundNode_Scopes(), "parent", null, 0, 1,
				Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScope_NextScope(), this.getScope(), this.getScope_PreviousScope(), "nextScope", null, 0, 1,
				Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScope_PreviousScope(), this.getScope(), this.getScope_NextScope(), "previousScope", null, 0,
				1, Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScope_Contents(), this.getCFNode(), this.getCFNode_Scope(), "contents", null, 0, -1,
				Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScope_Variables(), this.getCFVariable(), this.getCFVariable_Scope(), "variables", null, 0, -1,
				Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAction_ReassignedVariables(), this.getCFVariable(), this.getCFVariable_Reassignments(),
				"reassignedVariables", null, 0, -1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAction_CfNode(), this.getCFNode(), this.getCFNode_Actions(), "cfNode", null, 1, 1,
				Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAction_ConstructedVariables(), this.getCFVariable(), this.getCFVariable_Constructor(),
				"constructedVariables", null, 0, -1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAction_Next(), this.getAction(), this.getAction_Prev(), "next", null, 0, 1, Action.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAction_Prev(), this.getAction(), this.getAction_Next(), "prev", null, 0, 1, Action.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getAction__HasReferencedFreeParameters(), ecorePackage.getEBoolean(),
				"hasReferencedFreeParameters", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(uniformNoOperationVisitorEClass, UniformNoOperationVisitor.class, "UniformNoOperationVisitor",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getUniformNoOperationVisitor__VisitForEach__ForEach(), null, "visitForEach", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getForEach(), "forEach", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getUniformNoOperationVisitor__VisitHeadControlledLoop__HeadControlledLoop(), null,
				"visitHeadControlledLoop", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getHeadControlledLoop(), "headControlledLoop", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getUniformNoOperationVisitor__VisitIfStatement__IfStatement(), null, "visitIfStatement", 0,
				1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getIfStatement(), "ifStatement", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getUniformNoOperationVisitor__VisitTailControlledLoop__TailControlledLoop(), null,
				"visitTailControlledLoop", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getTailControlledLoop(), "tailControlledLoop", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(nodeDeletionEClass, NodeDeletion.class, "NodeDeletion", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeDeletion_DestructedVariables(), this.getCFVariable(), this.getCFVariable_Destructors(),
				"destructedVariables", null, 0, -1, NodeDeletion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getIfStatement__GetRelevantScope(), this.getScope(), "getRelevantScope", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(patternInvocationEClass, PatternInvocation.class, "PatternInvocation", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPatternInvocation_Pattern(), theSpecificationPackage.getPattern(), null, "pattern", null, 1,
				1, PatternInvocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPatternInvocation_Parameters(), this.getVariableReference(),
				this.getVariableReference_Invocation(), "parameters", null, 0, -1, PatternInvocation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getPatternInvocation__HasReferencedFreeParameters(), ecorePackage.getEBoolean(),
				"hasReferencedFreeParameters", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getPatternInvocation__IsMultipleMatch(), ecorePackage.getEBoolean(), "isMultipleMatch", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(visitorEClass, Visitor.class, "Visitor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getVisitor__VisitHeadControlledLoop__HeadControlledLoop(), null, "visitHeadControlledLoop",
				0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getHeadControlledLoop(), "headControlledLoop", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getVisitor__VisitIfStatement__IfStatement(), null, "visitIfStatement", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getIfStatement(), "ifStatement", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getVisitor__VisitTailControlledLoop__TailControlledLoop(), null, "visitTailControlledLoop",
				0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getTailControlledLoop(), "tailControlledLoop", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(variableReferenceEClass, VariableReference.class, "VariableReference", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVariableReference_Invocation(), this.getPatternInvocation(),
				this.getPatternInvocation_Parameters(), "invocation", null, 1, 1, VariableReference.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVariableReference_To(), theSpecificationPackage.getVariable(), null, "to", null, 1, 1,
				VariableReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVariableReference_From(), this.getCFVariable(), this.getCFVariable_References(), "from", null,
				1, 1, VariableReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getVariableReference__IsFree(), ecorePackage.getEBoolean(), "isFree", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEOperation(getVariableReference__IsConstructed(), ecorePackage.getEBoolean(), "isConstructed", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		initEOperation(getVariableReference__IsReassigned(), ecorePackage.getEBoolean(), "isReassigned", 0, 1,
				IS_UNIQUE, IS_ORDERED);
