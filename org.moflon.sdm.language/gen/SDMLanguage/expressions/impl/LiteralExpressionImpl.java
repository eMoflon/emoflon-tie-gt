 ...
 * <ul>
 *   <li>{@link SDMLanguage.expressions.impl.LiteralExpressionImpl#getType <em>Type</em>}</li>
 *   <li>{@link SDMLanguage.expressions.impl.LiteralExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralExpressionImpl extends ExpressionImpl implements LiteralExpression {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExpressionsPackage.LITERAL_EXPRESSION__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EClassifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.LITERAL_EXPRESSION__TYPE, oldType,
					type));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			...
			case ExpressionsPackage.LITERAL_EXPRESSION__TYPE:
				return SDMLanguagePackage.TYPED_ELEMENT__TYPE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			...
			case SDMLanguagePackage.TYPED_ELEMENT__TYPE:
				return ExpressionsPackage.LITERAL_EXPRESSION__TYPE;
			default:
				return -1;
			}
		}
