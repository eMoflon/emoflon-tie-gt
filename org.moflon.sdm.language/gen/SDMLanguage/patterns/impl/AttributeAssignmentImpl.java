 ...
 * <ul>
 *   <li>{@link SDMLanguage.patterns.impl.AttributeAssignmentImpl#getObjectVariable <em>Object Variable</em>}</li>
 *   <li>{@link SDMLanguage.patterns.impl.AttributeAssignmentImpl#getValueExpression <em>Value Expression</em>}</li>
 *   <li>{@link SDMLanguage.patterns.impl.AttributeAssignmentImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeAssignmentImpl extends EObjectImpl implements AttributeAssignment {
	...
	public void setObjectVariable(ObjectVariable newObjectVariable) {
		if (newObjectVariable != eInternalContainer()
				|| (eContainerFeatureID() != PatternsPackage.ATTRIBUTE_ASSIGNMENT__OBJECT_VARIABLE
		...
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject) valueExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PatternsPackage.ATTRIBUTE_ASSIGNMENT__VALUE_EXPRESSION, null, msgs);
