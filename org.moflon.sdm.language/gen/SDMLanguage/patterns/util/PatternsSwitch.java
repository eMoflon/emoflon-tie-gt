...
public class PatternsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PatternsPackage.APPLICATION_CONDITION_STORY_PATTERN: {
			ApplicationConditionStoryPattern applicationConditionStoryPattern = (ApplicationConditionStoryPattern) theEObject;
			T result = caseApplicationConditionStoryPattern(applicationConditionStoryPattern);
			if (result == null)
				result = caseStoryPattern(applicationConditionStoryPattern);
			if (result == null)
				result = caseCommentableElement(applicationConditionStoryPattern);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Application Condition Story Pattern</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Application Condition Story Pattern</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseApplicationConditionStoryPattern(ApplicationConditionStoryPattern object) {
		return null;
	}
