 ...
 * @generated
 */
public class PatternExpressionsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public PatternExpressionsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PatternExpressionsPackage.ATTRIBUTE_VALUE_EXPRESSION: {
			...
			if (result == null)
				result = caseObjectRefExpression(attributeValueExpression);
			if (result == null)
		...
		case PatternExpressionsPackage.OBJECT_REF_EXPRESSION: {
			ObjectRefExpression objectRefExpression = (ObjectRefExpression) theEObject;
			T result = caseObjectRefExpression(objectRefExpression);
			if (result == null)
				result = caseExpression(objectRefExpression);
			if (result == null)
				result = caseCommentableElement(objectRefExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PatternExpressionsPackage.OBJECT_VARIABLE_EXPRESSION: {
			...
			if (result == null)
				result = caseObjectRefExpression(objectVariableExpression);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Object Ref Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Object Ref Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObjectRefExpression(ObjectRefExpression object) {
		return null;
	}
