...
public class ActivitiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ActivitiesPackage.MOFLON_EOPERATION: {
			MoflonEOperation moflonEOperation = (MoflonEOperation) theEObject;
			T result = caseMoflonEOperation(moflonEOperation);
			if (result == null)
				result = caseEOperation(moflonEOperation);
			if (result == null)
				result = caseETypedElement(moflonEOperation);
			if (result == null)
				result = caseENamedElement(moflonEOperation);
			if (result == null)
				result = caseEModelElement(moflonEOperation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Moflon EOperation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Moflon EOperation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMoflonEOperation(MoflonEOperation object) {
		return null;
	}
