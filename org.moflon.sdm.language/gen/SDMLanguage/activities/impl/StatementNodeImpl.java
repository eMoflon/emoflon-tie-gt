 ...
 * <ul>
 *   <li>{@link SDMLanguage.activities.impl.StatementNodeImpl#getStatementExpression <em>Statement Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void setStatementExpression(Expression newStatementExpression) {
		if (newStatementExpression != statementExpression) {
			...
			if (statementExpression != null)
				msgs = ((InternalEObject) statementExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ActivitiesPackage.STATEMENT_NODE__STATEMENT_EXPRESSION, null, msgs);
			if (newStatementExpression != null)
				msgs = ((InternalEObject) newStatementExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - ActivitiesPackage.STATEMENT_NODE__STATEMENT_EXPRESSION, null, msgs);
