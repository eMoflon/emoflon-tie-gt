/**
 */
package SDMLanguage.calls.util;

import SDMLanguage.CommentableElement;

import SDMLanguage.calls.*;
 ...
 * <!-- end-user-doc -->
 * @see SDMLanguage.calls.CallsPackage
 * @generated
 */
public class CallsAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link SDMLanguage.calls.ParameterBinding <em>Parameter Binding</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
