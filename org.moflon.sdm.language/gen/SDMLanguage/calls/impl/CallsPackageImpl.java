...
import SDMLanguage.calls.CallsFactory;
...
public class CallsPackageImpl extends EPackageImpl implements CallsPackage {
	 ...
	 * @see SDMLanguage.calls.CallsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static CallsPackage init() {
		...
		CallsPackageImpl theCallsPackage = (CallsPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof CallsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new CallsPackageImpl());
	...
	public void initializePackageContents() {
		...
		CallExpressionsPackage theCallExpressionsPackage = (CallExpressionsPackage) EPackage.Registry.INSTANCE
				.getEPackage(CallExpressionsPackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(theCallExpressionsPackage);
		...
		invocationEClass.getESuperTypes().add(theSDMLanguagePackage.getCommentableElement());
		parameterBindingEClass.getESuperTypes().add(theSDMLanguagePackage.getCommentableElement());
		...
		initEReference(getInvocation_Callee(), ecorePackage.getEOperation(), null, "callee", null, 1, 1,
		...
		initEReference(getParameterBinding_Invocation(), this.getInvocation(),
				...
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getParameterBinding_Parameter(), ecorePackage.getEParameter(), null, "parameter", null, 1, 1,
