 ...
 * <ul>
 *   <li>{@link SDMLanguage.calls.impl.InvocationImpl#getOwnedParameterBindings <em>Owned Parameter Bindings</em>}</li>
 *   <li>{@link SDMLanguage.calls.impl.InvocationImpl#getCallee <em>Callee</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public EList<ParameterBinding> getOwnedParameterBindings() {
		if (ownedParameterBindings == null) {
			ownedParameterBindings = new EObjectContainmentWithInverseEList<ParameterBinding>(ParameterBinding.class,
					this, CallsPackage.INVOCATION__OWNED_PARAMETER_BINDINGS,
