/**
 */
package SDMLanguage.calls.impl;
 ...
 * <ul>
 *   <li>{@link SDMLanguage.calls.impl.ParameterBindingImpl#getValueExpression <em>Value Expression</em>}</li>
 *   <li>{@link SDMLanguage.calls.impl.ParameterBindingImpl#getInvocation <em>Invocation</em>}</li>
 *   <li>{@link SDMLanguage.calls.impl.ParameterBindingImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		if (newValueExpression != valueExpression) {
			...
			if (valueExpression != null)
				msgs = ((InternalEObject) valueExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CallsPackage.PARAMETER_BINDING__VALUE_EXPRESSION, null, msgs);
