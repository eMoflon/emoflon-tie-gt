/**
 */
package org.moflon.core.moca.processing.parser.util;
...
public class ParserAdapterFactory extends AdapterFactoryImpl {
	...
	protected ParserSwitch<Adapter> modelSwitch = new ParserSwitch<Adapter>() {
		...
		@Override
		public Adapter caseXMLParser(XMLParser object) {
			return createXMLParserAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.moflon.core.moca.processing.parser.Parser <em>Parser</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.moflon.core.moca.processing.parser.XMLParser <em>XML Parser</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXMLParserAdapter() {
		return null;
	}
