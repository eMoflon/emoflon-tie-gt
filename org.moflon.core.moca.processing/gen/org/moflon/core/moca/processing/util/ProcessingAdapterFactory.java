/**
 */
package org.moflon.core.moca.processing.util;
...
public class ProcessingAdapterFactory extends AdapterFactoryImpl {
	...
	protected ProcessingSwitch<Adapter> modelSwitch = new ProcessingSwitch<Adapter>() {
		@Override
		public Adapter caseCodeAdapter(CodeAdapter object) {
			return createCodeAdapterAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.moflon.core.moca.processing.CodeAdapter <em>Code Adapter</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCodeAdapterAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.moflon.core.moca.processing.Problem <em>Problem</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
