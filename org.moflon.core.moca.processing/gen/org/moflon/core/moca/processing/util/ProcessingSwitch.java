...
public class ProcessingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ProcessingPackage.CODE_ADAPTER: {
			CodeAdapter codeAdapter = (CodeAdapter) theEObject;
			T result = caseCodeAdapter(codeAdapter);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Code Adapter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Code Adapter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCodeAdapter(CodeAdapter object) {
		return null;
	}
