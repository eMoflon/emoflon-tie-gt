...
public enum Errors implements Enumerator {
    ...
    * @ordered
    */
   UNKNOWN_ATTRIBUTE_CONSTRAINT(0, "UNKNOWN_ATTRIBUTE_CONSTRAINT", "Found unknown attribute constraint with signature"),
    ...
    * @generated
    */
   private static final Errors[] VALUES_ARRAY = new Errors[] { UNKNOWN_ATTRIBUTE_CONSTRAINT, MALFORMED_ATTRIBUTE_CONSTRAINT, };
