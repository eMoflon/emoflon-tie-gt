...
public interface ConstraintstodemoclesFactory extends EFactory
{
    ...
    * @generated
    */
   ConstraintstodemoclesFactory eINSTANCE = org.moflon.sdm.constraints.constraintstodemocles.impl.ConstraintstodemoclesFactoryImpl.init();

   /**
    * Returns a new object of class '<em>Attribute Constraint Lib Util</em>'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return a new object of class '<em>Attribute Constraint Lib Util</em>'.
    * @generated
    */
   AttributeConstraintLibUtil createAttributeConstraintLibUtil();
