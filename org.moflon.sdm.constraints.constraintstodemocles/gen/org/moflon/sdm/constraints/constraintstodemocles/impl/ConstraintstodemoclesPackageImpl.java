...
public class ConstraintstodemoclesPackageImpl extends EPackageImpl implements ConstraintstodemoclesPackage
{
    ...
    * @generated
    */
   private EClass attributeConstraintLibUtilEClass = null;
   ...
   {
      if (isInited)
         return (ConstraintstodemoclesPackage) EPackage.Registry.INSTANCE.getEPackage(ConstraintstodemoclesPackage.eNS_URI);
      ...
      ConstraintstodemoclesPackageImpl theConstraintstodemoclesPackage = (ConstraintstodemoclesPackageImpl) (EPackage.Registry.INSTANCE
            .get(eNS_URI) instanceof ConstraintstodemoclesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ConstraintstodemoclesPackageImpl());
    ...
    * @generated
    */
   public EClass getAttributeConstraintLibUtil()
   {
      return attributeConstraintLibUtilEClass;
   }
    ...
    * @generated
    */
   public EReference getAttributeConstraintLibUtil_BuildInAttributeConstraintLibrary()
   {
      return (EReference) attributeConstraintLibUtilEClass.getEStructuralFeatures().get(0);
   }
    ...
    * @generated
    */
   public EReference getAttributeConstraintLibUtil_UserDefinedAttributeConstraintLibrary()
   {
      return (EReference) attributeConstraintLibUtilEClass.getEStructuralFeatures().get(1);
   }
    ...
    * @generated
    */
   public EOperation getAttributeConstraintLibUtil__SaveUserDefinedAttributeConstraintLibrary()
   {
      return attributeConstraintLibUtilEClass.getEOperations().get(0);
   }
    ...
    * @generated
    */
   public EReference getAttributeConstraintBlackAndNacPatternTransformer_AttributeConstraintLibUtil()
   {
      return (EReference) attributeConstraintBlackAndNacPatternTransformerEClass.getEStructuralFeatures().get(0);
   }
    ...
    * @generated
    */
   public EOperation getAttributeConstraintBlackAndNacPatternTransformer__ValidateConstraintLibrary__AttributeConstraintLibrary()
   {
   ...
   public void createPackageContents()
   {
      ...
      attributeConstraintLibUtilEClass = createEClass(ATTRIBUTE_CONSTRAINT_LIB_UTIL);
      createEReference(attributeConstraintLibUtilEClass, ATTRIBUTE_CONSTRAINT_LIB_UTIL__BUILD_IN_ATTRIBUTE_CONSTRAINT_LIBRARY);
      createEReference(attributeConstraintLibUtilEClass, ATTRIBUTE_CONSTRAINT_LIB_UTIL__USER_DEFINED_ATTRIBUTE_CONSTRAINT_LIBRARY);
      createEOperation(attributeConstraintLibUtilEClass, ATTRIBUTE_CONSTRAINT_LIB_UTIL___SAVE_USER_DEFINED_ATTRIBUTE_CONSTRAINT_LIBRARY);

      attributeConstraintBlackAndNacPatternTransformerEClass = createEClass(ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER);
      createEReference(attributeConstraintBlackAndNacPatternTransformerEClass,
            ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER__ATTRIBUTE_CONSTRAINT_LIB_UTIL);
      ...
      createEOperation(attributeConstraintBlackAndNacPatternTransformerEClass,
            ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___VALIDATE_CONSTRAINT_LIBRARY__ATTRIBUTECONSTRAINTLIBRARY);
      createEOperation(attributeConstraintBlackAndNacPatternTransformerEClass,
      ...
      createEOperation(attributeConstraintGreenPatternTransformerEClass, ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___POSTPROCESS__STORYPATTERN_PATTERN);
      ...
      createEOperation(attributeConstraintGreenPatternTransformerEClass, ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___IS_VARIABLE_TO_ADD__OBJECTVARIABLE);
      createEOperation(attributeConstraintGreenPatternTransformerEClass,
   ...
   public void initializePackageContents()
   {
      ...
      attributeConstraintBlackAndNacPatternTransformerEClass.getESuperTypes().add(thePatternPackage.getBlackAndNacPatternTransformer());
      attributeConstraintGreenPatternTransformerEClass.getESuperTypes().add(thePatternPackage.getGreenPatternTransformer());

      // Initialize classes, features, and operations; add parameters
      initEClass(attributeConstraintLibUtilEClass, AttributeConstraintLibUtil.class, "AttributeConstraintLibUtil", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);
      initEReference(getAttributeConstraintLibUtil_BuildInAttributeConstraintLibrary(), theOperationspecificationPackage.getAttributeConstraintLibrary(), null,
            "buildInAttributeConstraintLibrary", null, 0, 1, AttributeConstraintLibUtil.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
            IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getAttributeConstraintLibUtil_UserDefinedAttributeConstraintLibrary(), theOperationspecificationPackage.getAttributeConstraintLibrary(),
            null, "userDefinedAttributeConstraintLibrary", null, 0, 1, AttributeConstraintLibUtil.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
            !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      initEOperation(getAttributeConstraintLibUtil__SaveUserDefinedAttributeConstraintLibrary(), null, "saveUserDefinedAttributeConstraintLibrary", 0, 1,
            IS_UNIQUE, IS_ORDERED);

      initEClass(attributeConstraintBlackAndNacPatternTransformerEClass, AttributeConstraintBlackAndNacPatternTransformer.class,
            "AttributeConstraintBlackAndNacPatternTransformer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getAttributeConstraintBlackAndNacPatternTransformer_AttributeConstraintLibUtil(), this.getAttributeConstraintLibUtil(), null,
            "attributeConstraintLibUtil", null, 0, 1, AttributeConstraintBlackAndNacPatternTransformer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
            !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

      EOperation op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__Postprocess__StoryPattern_Pattern(), null, "postprocess", 0, 1,
            IS_UNIQUE, IS_ORDERED);
      ...
      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__ProcessPrimitiveVariable__PrimitiveVariable_Pattern(), null,
            "processPrimitiveVariable", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theAttributeConstraintsPackage.getPrimitiveVariable(), "primitiveVariable", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__ProcessLookupConstraint__AttributeLookupConstraint_Pattern(), null,
            "processLookupConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theAttributeConstraintsPackage.getAttributeLookupConstraint(), "lookupConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__ProcessCspConstraint__CspConstraint_Pattern(), null, "processCspConstraint", 0,
            1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theAttributeConstraintsPackage.getCspConstraint(), "cspConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__LookupVariableByName__String_Pattern(), theSpecificationPackage.getVariable(),
            "lookupVariableByName", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__CallSuperPostprocess__StoryPattern_Pattern(), null, "callSuperPostprocess", 0, 1,
            IS_UNIQUE, IS_ORDERED);
      addEParameter(op, thePatternsPackage.getStoryPattern(), "storyPattern", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__ValidateConstraintLibrary__AttributeConstraintLibrary(), null,
            "validateConstraintLibrary", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theOperationspecificationPackage.getAttributeConstraintLibrary(), "attributeConstraintLibrary", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__ValidateCspConstraints__AttributeVariableConstraint_CspConstraint(), null,
            "validateCspConstraints", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theDemoclesPackage.getAttributeVariableConstraint(), "attributeConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theAttributeConstraintsPackage.getCspConstraint(), "cspConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(
            getAttributeConstraintBlackAndNacPatternTransformer__UpdateUserDefinedConstraintLib__AttributeVariableConstraint_AttributeConstraintLibrary(), null,
            "updateUserDefinedConstraintLib", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theDemoclesPackage.getAttributeVariableConstraint(), "attributeConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theOperationspecificationPackage.getAttributeConstraintLibrary(), "userDefinedLib", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintBlackAndNacPatternTransformer__CreateErrorMessage__EObject(), theResultPackage.getErrorMessage(),
            "createErrorMessage", 0, 1, IS_UNIQUE, IS_ORDERED);
      ...
      op = initEOperation(getAttributeConstraintGreenPatternTransformer__Postprocess__StoryPattern_Pattern(), null, "postprocess", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, thePatternsPackage.getStoryPattern(), "storyPattern", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintGreenPatternTransformer__CallSuperPostprocess__StoryPattern_Pattern(), null, "callSuperPostprocess", 0, 1,
            IS_UNIQUE, IS_ORDERED);
      addEParameter(op, thePatternsPackage.getStoryPattern(), "storyPattern", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintGreenPatternTransformer__ProcessAssignmentConstraint__AssignmentConstraint_Pattern(), null,
            "processAssignmentConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theAttributeConstraintsPackage.getAssignmentConstraint(), "assignmentConstraint", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintGreenPatternTransformer__LookupVariableByName__String_Pattern(), theSpecificationPackage.getVariable(),
            "lookupVariableByName", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, ecorePackage.getEString(), "variableName", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, theSpecificationPackage.getPattern(), "pattern", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintGreenPatternTransformer__IsVariableToAdd__ObjectVariable(), ecorePackage.getEBoolean(), "isVariableToAdd", 0, 1,
            IS_UNIQUE, IS_ORDERED);
      addEParameter(op, thePatternsPackage.getObjectVariable(), "objectVariable", 0, 1, IS_UNIQUE, IS_ORDERED);

      op = initEOperation(getAttributeConstraintGreenPatternTransformer__CallSuperIsVariableToAdd__ObjectVariable(), ecorePackage.getEBoolean(),
            "callSuperIsVariableToAdd", 0, 1, IS_UNIQUE, IS_ORDERED);
      addEParameter(op, thePatternsPackage.getObjectVariable(), "objectVariable", 0, 1, IS_UNIQUE, IS_ORDERED);

      initEClass(identifyerHelperEClass, IdentifyerHelper.class, "IdentifyerHelper", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

      initEOperation(getIdentifyerHelper__GetNextIdentifyer(), ecorePackage.getEString(), "getNextIdentifyer", 0, 1, IS_UNIQUE, IS_ORDERED);
