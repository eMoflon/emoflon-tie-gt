...
public class ConstraintstodemoclesFactoryImpl extends EFactoryImpl implements ConstraintstodemoclesFactory
{
   ...
   public EObject create(EClass eClass)
   {
      ...
      case ConstraintstodemoclesPackage.ATTRIBUTE_CONSTRAINT_LIB_UTIL:
         return createAttributeConstraintLibUtil();
    ...
    * @generated
    */
   public AttributeConstraintLibUtil createAttributeConstraintLibUtil()
   {
      AttributeConstraintLibUtilImpl attributeConstraintLibUtil = new AttributeConstraintLibUtilImpl();
