 ...
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel basePackage='org.moflon.sdm.constraints'"
 * @generated
 */
public interface ConstraintstodemoclesPackage extends EPackage
{
    ...
    * @generated
    */
   String eNAME = "constraintstodemocles";
    ...
    * @generated
    */
   ConstraintstodemoclesPackage eINSTANCE = org.moflon.sdm.constraints.constraintstodemocles.impl.ConstraintstodemoclesPackageImpl.init();

   /**
    * The meta object id for the '{@link org.moflon.sdm.constraints.constraintstodemocles.impl.AttributeConstraintLibUtilImpl <em>Attribute Constraint Lib Util</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see org.moflon.sdm.constraints.constraintstodemocles.impl.AttributeConstraintLibUtilImpl
    * @see org.moflon.sdm.constraints.constraintstodemocles.impl.ConstraintstodemoclesPackageImpl#getAttributeConstraintLibUtil()
    * @generated
    */
   int ATTRIBUTE_CONSTRAINT_LIB_UTIL = 0;

   /**
    * The feature id for the '<em><b>Build In Attribute Constraint Library</b></em>' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_LIB_UTIL__BUILD_IN_ATTRIBUTE_CONSTRAINT_LIBRARY = 0;

   /**
    * The feature id for the '<em><b>User Defined Attribute Constraint Library</b></em>' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_LIB_UTIL__USER_DEFINED_ATTRIBUTE_CONSTRAINT_LIBRARY = 1;

   /**
    * The number of structural features of the '<em>Attribute Constraint Lib Util</em>' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_LIB_UTIL_FEATURE_COUNT = 2;

   /**
    * The operation id for the '<em>Save User Defined Attribute Constraint Library</em>' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_LIB_UTIL___SAVE_USER_DEFINED_ATTRIBUTE_CONSTRAINT_LIBRARY = 0;

   /**
    * The number of operations of the '<em>Attribute Constraint Lib Util</em>' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_LIB_UTIL_OPERATION_COUNT = 1;
    ...
    * @generated
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER = 1;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER__VALIDATION_REPORT = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER__VALIDATION_REPORT;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER__EXPRESSION_TRANSFORMER = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER__EXPRESSION_TRANSFORMER;

   /**
    * The feature id for the '<em><b>Attribute Constraint Lib Util</b></em>' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER__ATTRIBUTE_CONSTRAINT_LIB_UTIL = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_FEATURE_COUNT
         + 0;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER_FEATURE_COUNT = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___CONCAT__STRING_STRING = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___CONCAT__STRING_STRING;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___GET_ATTRIBUTE_VARIABLE__OBJECTVARIABLE_EATTRIBUTE_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___GET_ATTRIBUTE_VARIABLE__OBJECTVARIABLE_EATTRIBUTE_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___LOOKUP_VARIABLE_IN_PATTERN__PATTERN_STRING_ECLASSIFIER = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___LOOKUP_VARIABLE_IN_PATTERN__PATTERN_STRING_ECLASSIFIER;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___ADD_LINK_TO_PATTERN__LINKVARIABLE_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___ADD_LINK_TO_PATTERN__LINKVARIABLE_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___GET_EREFERENCE__LINKVARIABLE = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___GET_EREFERENCE__LINKVARIABLE;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___HAS_SYMBOLIC_PARAMETER__PATTERN_STRING = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___HAS_SYMBOLIC_PARAMETER__PATTERN_STRING;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___PROCESS_LINK_VARIABLES__STORYPATTERN_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___PROCESS_LINK_VARIABLES__STORYPATTERN_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___TRANSFORM__STORYPATTERN_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___TRANSFORM__STORYPATTERN_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___ANALYZE_INJECTIVITY__PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___ANALYZE_INJECTIVITY__PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___ARE_COMPATIBLE_TYPES__ECLASSIFIER_ECLASSIFIER = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___ARE_COMPATIBLE_TYPES__ECLASSIFIER_ECLASSIFIER;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___CREATE_INJECTIVITY_CONSTRAINT__PATTERN_VARIABLE_VARIABLE = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___CREATE_INJECTIVITY_CONSTRAINT__PATTERN_VARIABLE_VARIABLE;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___CREATE_RELATIONAL_CONSTRAINT__COMPARISONEXPRESSION = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___CREATE_RELATIONAL_CONSTRAINT__COMPARISONEXPRESSION;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___INJECTIVE_MAPPING_REQUIRED__VARIABLE_VARIABLE = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___INJECTIVE_MAPPING_REQUIRED__VARIABLE_VARIABLE;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___IS_LINK_TO_ADD__LINKVARIABLE_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___IS_LINK_TO_ADD__LINKVARIABLE_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___IS_VARIABLE_TO_ADD__OBJECTVARIABLE = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___IS_VARIABLE_TO_ADD__OBJECTVARIABLE;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___TRANSFORM_ATTRIBUTE_CONSTRAINT__CONSTRAINT_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER___TRANSFORM_ATTRIBUTE_CONSTRAINT__CONSTRAINT_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___POSTPROCESS__STORYPATTERN_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 0;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___PROCESS_PRIMITIVE_VARIABLE__PRIMITIVEVARIABLE_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 1;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___PROCESS_LOOKUP_CONSTRAINT__ATTRIBUTELOOKUPCONSTRAINT_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 2;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___PROCESS_CSP_CONSTRAINT__CSPCONSTRAINT_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 3;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___LOOKUP_VARIABLE_BY_NAME__STRING_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 4;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___CALL_SUPER_POSTPROCESS__STORYPATTERN_PATTERN = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 5;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___VALIDATE_CONSTRAINT_LIBRARY__ATTRIBUTECONSTRAINTLIBRARY = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 6;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___VALIDATE_CSP_CONSTRAINTS__ATTRIBUTEVARIABLECONSTRAINT_CSPCONSTRAINT = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 7;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___UPDATE_USER_DEFINED_CONSTRAINT_LIB__ATTRIBUTEVARIABLECONSTRAINT_ATTRIBUTECONSTRAINTLIBRARY = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 8;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___CREATE_ERROR_MESSAGE__EOBJECT = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 9;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT = PatternPackage.BLACK_AND_NAC_PATTERN_TRANSFORMER_OPERATION_COUNT + 10;
    ...
    * @generated
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER = 2;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER__VALIDATION_REPORT = PatternPackage.GREEN_PATTERN_TRANSFORMER__VALIDATION_REPORT;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER__EXPRESSION_TRANSFORMER = PatternPackage.GREEN_PATTERN_TRANSFORMER__EXPRESSION_TRANSFORMER;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER_FEATURE_COUNT = PatternPackage.GREEN_PATTERN_TRANSFORMER_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___CONCAT__STRING_STRING = PatternPackage.GREEN_PATTERN_TRANSFORMER___CONCAT__STRING_STRING;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___GET_ATTRIBUTE_VARIABLE__OBJECTVARIABLE_EATTRIBUTE_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER___GET_ATTRIBUTE_VARIABLE__OBJECTVARIABLE_EATTRIBUTE_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___LOOKUP_VARIABLE_IN_PATTERN__PATTERN_STRING_ECLASSIFIER = PatternPackage.GREEN_PATTERN_TRANSFORMER___LOOKUP_VARIABLE_IN_PATTERN__PATTERN_STRING_ECLASSIFIER;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___ADD_LINK_TO_PATTERN__LINKVARIABLE_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER___ADD_LINK_TO_PATTERN__LINKVARIABLE_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___GET_EREFERENCE__LINKVARIABLE = PatternPackage.GREEN_PATTERN_TRANSFORMER___GET_EREFERENCE__LINKVARIABLE;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___HAS_SYMBOLIC_PARAMETER__PATTERN_STRING = PatternPackage.GREEN_PATTERN_TRANSFORMER___HAS_SYMBOLIC_PARAMETER__PATTERN_STRING;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___PROCESS_LINK_VARIABLES__STORYPATTERN_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER___PROCESS_LINK_VARIABLES__STORYPATTERN_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___TRANSFORM__STORYPATTERN_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER___TRANSFORM__STORYPATTERN_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___IS_LINK_TO_ADD__LINKVARIABLE_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER___IS_LINK_TO_ADD__LINKVARIABLE_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___TRANSFORM_ASSIGNMENT__ATTRIBUTEASSIGNMENT_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER___TRANSFORM_ASSIGNMENT__ATTRIBUTEASSIGNMENT_PATTERN;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___POSTPROCESS__STORYPATTERN_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT + 0;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___CALL_SUPER_POSTPROCESS__STORYPATTERN_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 1;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___PROCESS_ASSIGNMENT_CONSTRAINT__ASSIGNMENTCONSTRAINT_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 2;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___LOOKUP_VARIABLE_BY_NAME__STRING_PATTERN = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT + 3;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___IS_VARIABLE_TO_ADD__OBJECTVARIABLE = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT + 4;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER___CALL_SUPER_IS_VARIABLE_TO_ADD__OBJECTVARIABLE = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT
         + 5;
    ...
    * @ordered
    */
   int ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT = PatternPackage.GREEN_PATTERN_TRANSFORMER_OPERATION_COUNT + 6;
   ...
   /**
    * Returns the meta object for class '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil <em>Attribute Constraint Lib Util</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Attribute Constraint Lib Util</em>'.
    * @see org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil
    * @generated
    */
   EClass getAttributeConstraintLibUtil();

   /**
    * Returns the meta object for the reference '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil#getBuildInAttributeConstraintLibrary <em>Build In Attribute Constraint Library</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Build In Attribute Constraint Library</em>'.
    * @see org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil#getBuildInAttributeConstraintLibrary()
    * @see #getAttributeConstraintLibUtil()
    * @generated
    */
   EReference getAttributeConstraintLibUtil_BuildInAttributeConstraintLibrary();

   /**
    * Returns the meta object for the reference '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil#getUserDefinedAttributeConstraintLibrary <em>User Defined Attribute Constraint Library</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>User Defined Attribute Constraint Library</em>'.
    * @see org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil#getUserDefinedAttributeConstraintLibrary()
    * @see #getAttributeConstraintLibUtil()
    * @generated
    */
   EReference getAttributeConstraintLibUtil_UserDefinedAttributeConstraintLibrary();

   /**
    * Returns the meta object for the '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil#saveUserDefinedAttributeConstraintLibrary() <em>Save User Defined Attribute Constraint Library</em>}' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the '<em>Save User Defined Attribute Constraint Library</em>' operation.
    * @see org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil#saveUserDefinedAttributeConstraintLibrary()
    * @generated
    */
   EOperation getAttributeConstraintLibUtil__SaveUserDefinedAttributeConstraintLibrary();
   ...
   /**
    * Returns the meta object for the reference '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintBlackAndNacPatternTransformer#getAttributeConstraintLibUtil <em>Attribute Constraint Lib Util</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Attribute Constraint Lib Util</em>'.
    * @see org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintBlackAndNacPatternTransformer#getAttributeConstraintLibUtil()
    * @see #getAttributeConstraintBlackAndNacPatternTransformer()
    * @generated
    */
   EReference getAttributeConstraintBlackAndNacPatternTransformer_AttributeConstraintLibUtil();
   ...
   /**
    * Returns the meta object for the '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintBlackAndNacPatternTransformer#validateConstraintLibrary(org.moflon.sdm.constraints.operationspecification.AttributeConstraintLibrary) <em>Validate Constraint Library</em>}' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the '<em>Validate Constraint Library</em>' operation.
    * @see org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintBlackAndNacPatternTransformer#validateConstraintLibrary(org.moflon.sdm.constraints.operationspecification.AttributeConstraintLibrary)
    * @generated
    */
   EOperation getAttributeConstraintBlackAndNacPatternTransformer__ValidateConstraintLibrary__AttributeConstraintLibrary();
   ...
   {
      /**
       * The meta object literal for the '{@link org.moflon.sdm.constraints.constraintstodemocles.impl.AttributeConstraintLibUtilImpl <em>Attribute Constraint Lib Util</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see org.moflon.sdm.constraints.constraintstodemocles.impl.AttributeConstraintLibUtilImpl
       * @see org.moflon.sdm.constraints.constraintstodemocles.impl.ConstraintstodemoclesPackageImpl#getAttributeConstraintLibUtil()
       * @generated
       */
      EClass ATTRIBUTE_CONSTRAINT_LIB_UTIL = eINSTANCE.getAttributeConstraintLibUtil();

      /**
       * The meta object literal for the '<em><b>Build In Attribute Constraint Library</b></em>' reference feature.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EReference ATTRIBUTE_CONSTRAINT_LIB_UTIL__BUILD_IN_ATTRIBUTE_CONSTRAINT_LIBRARY = eINSTANCE
            .getAttributeConstraintLibUtil_BuildInAttributeConstraintLibrary();

      /**
       * The meta object literal for the '<em><b>User Defined Attribute Constraint Library</b></em>' reference feature.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EReference ATTRIBUTE_CONSTRAINT_LIB_UTIL__USER_DEFINED_ATTRIBUTE_CONSTRAINT_LIBRARY = eINSTANCE
            .getAttributeConstraintLibUtil_UserDefinedAttributeConstraintLibrary();

      /**
       * The meta object literal for the '<em><b>Save User Defined Attribute Constraint Library</b></em>' operation.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EOperation ATTRIBUTE_CONSTRAINT_LIB_UTIL___SAVE_USER_DEFINED_ATTRIBUTE_CONSTRAINT_LIBRARY = eINSTANCE
            .getAttributeConstraintLibUtil__SaveUserDefinedAttributeConstraintLibrary();
       ...
       * @generated
       */
      EClass ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER = eINSTANCE.getAttributeConstraintBlackAndNacPatternTransformer();

      /**
       * The meta object literal for the '<em><b>Attribute Constraint Lib Util</b></em>' reference feature.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EReference ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER__ATTRIBUTE_CONSTRAINT_LIB_UTIL = eINSTANCE
            .getAttributeConstraintBlackAndNacPatternTransformer_AttributeConstraintLibUtil();
       ...
       * @generated
       */
      EOperation ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER___VALIDATE_CONSTRAINT_LIBRARY__ATTRIBUTECONSTRAINTLIBRARY = eINSTANCE
            .getAttributeConstraintBlackAndNacPatternTransformer__ValidateConstraintLibrary__AttributeConstraintLibrary();
       ...
       * @generated
       */
      EClass ATTRIBUTE_CONSTRAINT_GREEN_PATTERN_TRANSFORMER = eINSTANCE.getAttributeConstraintGreenPatternTransformer();
