...
public class ConstraintstodemoclesSwitch<T> extends Switch<T>
{
   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
      case ConstraintstodemoclesPackage.ATTRIBUTE_CONSTRAINT_LIB_UTIL:
      {
         AttributeConstraintLibUtil attributeConstraintLibUtil = (AttributeConstraintLibUtil) theEObject;
         T result = caseAttributeConstraintLibUtil(attributeConstraintLibUtil);
         if (result == null)
      ...
      case ConstraintstodemoclesPackage.ATTRIBUTE_CONSTRAINT_BLACK_AND_NAC_PATTERN_TRANSFORMER:
      {
         ...
         T result = caseAttributeConstraintBlackAndNacPatternTransformer(attributeConstraintBlackAndNacPatternTransformer);
         if (result == null)
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Attribute Constraint Lib Util</em>'.
    * <!-- begin-user-doc -->
    * This implementation returns null;
    * returning a non-null result will terminate the switch.
    * <!-- end-user-doc -->
    * @param object the target of the switch.
    * @return the result of interpreting the object as an instance of '<em>Attribute Constraint Lib Util</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseAttributeConstraintLibUtil(AttributeConstraintLibUtil object)
   {
      return null;
   }
    ...
    * @generated
    */
   public T caseAttributeConstraintBlackAndNacPatternTransformer(AttributeConstraintBlackAndNacPatternTransformer object)
   {
      return null;
   }
