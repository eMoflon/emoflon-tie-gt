...
public class ConstraintstodemoclesAdapterFactory extends AdapterFactoryImpl
{
   ...
   protected ConstraintstodemoclesSwitch<Adapter> modelSwitch = new ConstraintstodemoclesSwitch<Adapter>() {
      @Override
      public Adapter caseAttributeConstraintLibUtil(AttributeConstraintLibUtil object)
      {
         return createAttributeConstraintLibUtilAdapter();
      }

      @Override
      public Adapter caseAttributeConstraintBlackAndNacPatternTransformer(AttributeConstraintBlackAndNacPatternTransformer object)
      {
         return createAttributeConstraintBlackAndNacPatternTransformerAdapter();
      }

      @Override
      public Adapter caseAttributeConstraintGreenPatternTransformer(AttributeConstraintGreenPatternTransformer object)
      {
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.moflon.sdm.constraints.constraintstodemocles.AttributeConstraintLibUtil <em>Attribute Constraint Lib Util</em>}'.
    * <!-- begin-user-doc -->
    ...
    * @generated
    */
   public Adapter createAttributeConstraintLibUtilAdapter()
   {
      return null;
   }
