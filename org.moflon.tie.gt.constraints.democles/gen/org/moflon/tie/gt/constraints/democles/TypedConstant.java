 ...
 * <ul>
 *   <li>{@link org.moflon.tie.gt.constraints.democles.TypedConstant#getEClassifier <em>EClassifier</em>}</li>
 * </ul>
 * </p>
 *
...
public class TypedConstant extends Constant implements EObject
{
    ...
    * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getTypedConstant_EClassifier()
    * @model
    * @generated
    */
      ...
      if (eClassifier != null && eClassifier.eIsProxy())
      {
         ...
         if (eClassifier != oldEClassifier)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, DemoclesPackage.TYPED_CONSTANT__ECLASSIFIER, oldEClassifier, eClassifier));
         }
      }
      return eClassifier;
   }
   ...
   /**
    * Sets the value of the '{@link org.moflon.tie.gt.constraints.democles.TypedConstant#getEClassifier <em>EClassifier</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   public void setEClassifier(EClassifier newEClassifier)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, DemoclesPackage.TYPED_CONSTANT__ECLASSIFIER, oldEClassifier, eClassifier));
   }
