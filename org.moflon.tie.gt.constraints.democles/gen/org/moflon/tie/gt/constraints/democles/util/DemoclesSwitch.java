...
public class DemoclesSwitch<T> extends Switch<T>
{
   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      ...
      {
         AttributeVariableConstraint attributeVariableConstraint = (AttributeVariableConstraint) theEObject;
         T result = caseAttributeVariableConstraint(attributeVariableConstraint);
         if (result == null)
            result = caseConstraint(attributeVariableConstraint);
         if (result == null)
      ...
      case DemoclesPackage.ATTRIBUTE_VALUE_CONSTRAINT:
      {
         ...
         if (result == null)
            result = (T) caseEMFConstraint(attributeValueConstraint);
         if (result == null)
      ...
      case DemoclesPackage.TYPED_CONSTANT:
      {
         ...
         if (result == null)
            result = caseConstant(typedConstant);
         if (result == null)
            result = caseConstraintVariable(typedConstant);
         if (result == null)
            result = defaultCase(theEObject);
         return result;
      }
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Attribute Variable Constraint</em>'.
    * <!-- begin-user-doc -->
    * This implementation returns null;
    * returning a non-null result will terminate the switch.
    * <!-- end-user-doc -->
    * @param object the target of the switch.
    * @return the result of interpreting the object as an instance of '<em>Attribute Variable Constraint</em>'.
    * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
    * @generated
    */
   public T caseAttributeVariableConstraint(AttributeVariableConstraint object)
   {
      return null;
   }
