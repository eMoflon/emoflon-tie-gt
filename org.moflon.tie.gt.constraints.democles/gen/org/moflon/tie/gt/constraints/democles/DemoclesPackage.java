/**
 */
package org.moflon.tie.gt.constraints.democles;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.moflon.tie.gt.constraints.democles.DemoclesFactory
 * @model kind="package"
...
public class DemoclesPackage extends EPackageImpl
{
    ...
    * @generated
    */
   public static final String eNAME = "democles";
    ...
    * @generated
    */
   public static final String eNS_URI = "platform:/plugin/org.moflon.tie.gt.constraints.democles/model/Democles.ecore";
    ...
    * @generated
    */
   public static final String eNS_PREFIX = "org.moflon.tie.gt.constraints.democles";
    ...
    * @generated
    */
   public static final DemoclesPackage eINSTANCE = org.moflon.tie.gt.constraints.democles.DemoclesPackage.init();

   /**
    * The meta object id for the '{@link org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint <em>Attribute Variable Constraint</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint
    * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getAttributeVariableConstraint()
    * @generated
    */
    ...
    * @ordered
    */
   public static final int ATTRIBUTE_VARIABLE_CONSTRAINT__PREDICATE_SYMBOL = SpecificationPackage.CONSTRAINT_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   public static final int ATTRIBUTE_VARIABLE_CONSTRAINT_FEATURE_COUNT = SpecificationPackage.CONSTRAINT_FEATURE_COUNT + 1;

   /**
    * The meta object id for the '{@link org.moflon.tie.gt.constraints.democles.AttributeValueConstraint <em>Attribute Value Constraint</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see org.moflon.tie.gt.constraints.democles.AttributeValueConstraint
    * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getAttributeValueConstraint()
    * @generated
    */
   ...
   /**
    * The meta object id for the '{@link org.moflon.tie.gt.constraints.democles.TypedConstant <em>Typed Constant</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see org.moflon.tie.gt.constraints.democles.TypedConstant
    * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getTypedConstant()
    * @generated
    */
    ...
    * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#eNS_URI
    * @see #init()
    * @generated
    */
   ...
   public static DemoclesPackage init()
   {
      ...
      DemoclesPackage theDemoclesPackage = (DemoclesPackage) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DemoclesPackage
   ...
   /**
    * Returns the meta object for class '{@link org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint <em>Attribute Variable Constraint</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the attribute '{@link org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint#getPredicateSymbol <em>Predicate Symbol</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>Predicate Symbol</em>'.
    * @see org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint#getPredicateSymbol()
   ...
   /**
    * Returns the meta object for class '{@link org.moflon.tie.gt.constraints.democles.AttributeValueConstraint <em>Attribute Value Constraint</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link org.moflon.tie.gt.constraints.democles.TypedConstant <em>Typed Constant</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the reference '{@link org.moflon.tie.gt.constraints.democles.TypedConstant#getEClassifier <em>EClassifier</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>EClassifier</em>'.
    * @see org.moflon.tie.gt.constraints.democles.TypedConstant#getEClassifier()
   ...
   public void initializePackageContents()
   {
      ...
      EMFTypePackage theEMFTypePackage = (EMFTypePackage) EPackage.Registry.INSTANCE.getEPackage(EMFTypePackage.eNS_URI);
      ...
      initEClass(attributeVariableConstraintEClass, AttributeVariableConstraint.class, "AttributeVariableConstraint", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);
      initEAttribute(getAttributeVariableConstraint_PredicateSymbol(), ecorePackage.getEString(), "predicateSymbol", null, 1, 1,
            AttributeVariableConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(attributeValueConstraintEClass, AttributeValueConstraint.class, "AttributeValueConstraint", !IS_ABSTRACT, !IS_INTERFACE,
            IS_GENERATED_INSTANCE_CLASS);

      initEClass(typedConstantEClass, TypedConstant.class, "TypedConstant", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getTypedConstant_EClassifier(), ecorePackage.getEClassifier(), null, "eClassifier", null, 0, 1, TypedConstant.class, !IS_TRANSIENT,
   ...
   {
      /**
       * The meta object literal for the '{@link org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint <em>Attribute Variable Constraint</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see org.moflon.tie.gt.constraints.democles.AttributeVariableConstraint
       * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getAttributeVariableConstraint()
       ...
       * @generated
       */
      public static final EAttribute ATTRIBUTE_VARIABLE_CONSTRAINT__PREDICATE_SYMBOL = eINSTANCE.getAttributeVariableConstraint_PredicateSymbol();

      /**
       * The meta object literal for the '{@link org.moflon.tie.gt.constraints.democles.AttributeValueConstraint <em>Attribute Value Constraint</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see org.moflon.tie.gt.constraints.democles.AttributeValueConstraint
       * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getAttributeValueConstraint()
      ...
      /**
       * The meta object literal for the '{@link org.moflon.tie.gt.constraints.democles.TypedConstant <em>Typed Constant</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see org.moflon.tie.gt.constraints.democles.TypedConstant
       * @see org.moflon.tie.gt.constraints.democles.DemoclesPackage#getTypedConstant()
